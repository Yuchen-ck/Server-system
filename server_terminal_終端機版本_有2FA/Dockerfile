...
COPY *.txt /home/qtuser/Server-system/
RUN python3.7 -m pip install -r /home/qtuser/Server-system/requirements.txt

# Add user for user Pyqt5
RUN adduser --quiet --disabled-password qtuser

# Copy python code
COPY * /home/qtuser/Server-system/
RUN chmod -R 777 /home/qtuser
# Change work directory
WORKDIR "/home/qtuser/Server-system"
